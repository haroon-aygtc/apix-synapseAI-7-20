...
import { ArrowRight, CheckCircle, ChevronRight, Globe, Lock, MessageSquare, Zap } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="#why-us" className="text-sm font-medium hover:text-primary transition-colors">Why Choose Us</Link>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-muted-foreground md:text-xl">
                  SynapseAI platform empowers you to create, deploy, and manage AI agents that transform your business operations.
                </p>
                ...
                <div className="relative rounded-xl border bg-card p-1 shadow-xl">
                  <div className="rounded-lg bg-muted aspect-video overflow-hidden">
                    <img 
                      ...
                      onError={(e) => {
                        e.currentTarget.src = "https://placehold.co/600x400/2563eb/ffffff?text=SynapseAI+Dashboard";
                      }}
                    />
                  </div>
                </div>
              ...
              {[
                {
                  ...
                  description: "Build custom AI agents with our intuitive drag-and-drop interface. No coding required."
                },
                {
                  icon: <Globe className="h-8 w-8 text-primary" />,
                  title: "Seamless Integration",
                  description: "Connect to your existing tools and systems with our extensive library of pre-built integrations."
                },
                {
                ...
                },
                {
                  ...
                  description: "Advanced NLP capabilities to understand and process human language with high accuracy."
                },
                {
                  icon: <CheckCircle className="h-8 w-8 text-primary" />,
                  title: "Workflow Automation",
                  description: "Automate complex business processes with intelligent workflows that adapt and learn."
                },
                {
                  icon: <Zap className="h-8 w-8 text-primary" />,
                  title: "Real-time Analytics",
                  description: "Monitor performance and gain insights with comprehensive analytics and reporting."
                }
              ].map((feature, i) => (
                <motion.div 
                  key={i}
                ...
                >
                  <div className="p-3 rounded-lg bg-primary/10 mb-4">{feature.icon}</div>
        ...
        <section id="why-us" className="py-20 md:py-32 bg-muted/30">
          <div className="container px-4 md:px-6">
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              >
                <div className="aspect-video">
                  <img 
                    ...
                    className="w-full h-full object-cover"
                    onError={(e) => {
                      e.currentTarget.src = "https://placehold.co/600x400/2563eb/ffffff?text=Why+Choose+SynapseAI";
                    }}
                  />
                </div>
              </motion.div>
              ...
              >
                <div>
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Why Choose SynapseAI</h2>
                  <p className="mt-4 text-muted-foreground">
                    We deliver exceptional value through our cutting-edge AI platform designed specifically for enterprise needs.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description: "Weekly updates with new features and improvements based on customer feedback."
                    },
                    {
        ...
        <section id="testimonials" className="py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  quote: "SynapseAI has transformed how we handle customer support. Our response time has decreased by 80% while customer satisfaction increased by 35%.",
                  author: "Sarah Johnson",
                  role: "CTO, TechCorp",
                  image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah"
                },
                {
                  quote: "The workflow automation capabilities are incredible. We've automated 75% of our manual processes, saving over 2,000 hours per month.",
                  author: "Michael Chen",
                  role: "Operations Director, Global Logistics",
                  image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Michael"
                },
                {
                  quote: "Implementation was seamless and the ROI was immediate. Within 3 months, we saw a 40% reduction in operational costs.",
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center max-w-[800px] mx-auto">
              <motion.div
                ...
                className="w-full"
              >
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Stay Updated with SynapseAI</h2>
            ...
            <div className="flex flex-col items-center text-center max-w-[800px] mx-auto">
              ...
              >
                ...
                <p className="mt-4 md:text-xl opacity-90">
                  Start building intelligent AI agents today and stay ahead of the competition.
                </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 lg:col-span-2">
              ...
              <div className="flex space-x-4">
                {["twitter", "linkedin", "facebook", "github"].map((social) => (
                  <a key={social} href={`#${social}`} className="text-muted-foreground hover:text-foreground">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {["Documentation", "Tutorials", "API Reference", "Community", "Support"].map((item) => (
                  <li key={item}>
                    <Link href="#" className="text-muted-foreground hover:text-foreground transition-colors">
                      {item}
                    </Link>
